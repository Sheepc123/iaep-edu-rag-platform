            ...
            <div className="flex-1 flex flex-col overflow-hidden">
              ...
              {messages.length === 1 && (
                <div className="px-6 py-4 bg-gray-50 border-t">
                  <p className="text-sm text-gray-600 mb-3 font-medium">快速开始：</p>
                  <div className="grid grid-cols-2 gap-3">
                    {quickActions.map((action, index) => (
                      <motion.button
                        ...
                        className="flex items-center space-x-3 p-3 bg-white hover:bg-blue-50 rounded-xl border border-gray-100 hover:border-blue-200 text-left transition-all duration-200"
                      >
